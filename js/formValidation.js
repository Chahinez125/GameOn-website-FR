...
function checkFirstName() {
  return checkSimpleString(firstName) === true;
}
// vérification du nom de famille
function checkLastName() {
  return checkSimpleString(lastName) === true;
}
...
form.addEventListener("submit", function (e) {
  ...
  formulaireEnErreur= checkFirstName();
  formulaireEnErreur+=checkLastName();
  formulaireEnErreur+=checkEmail();
  formulaireEnErreur+=checkBirthdate();
  formulaireEnErreur+=checkQuantity();
  formulaireEnErreur+=checkLocations();
  formulaireEnErreur+=checkCheckBox();

  console.log(formulaireEnErreur);

  if (formulaireEnErreur == 7) {
